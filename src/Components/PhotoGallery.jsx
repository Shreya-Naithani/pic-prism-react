...
const PhotoGallery = () => {
  return (
    <div className='my-20 bg-white flex flex-col justify-center items-center'>
      ...
      {/* All my photos will be listed here */}
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 mb-20'>
   {/* Image Card */}
      <ImageCard title="The Beach"
       author="shreya Naithani" 
       price="20"
       img="https://images.pexels.com/photos/3238764/pexels-photo-3238764.jpeg"
       icon1={ <FaShoppingCart className='text-2xl text-black cursor-pointer hover:scale-110 transition-all duration-300 ease-linear' />}
       icon2={<IoIosHeart className='text-2xl text-red-500 cursor-pointer hover:scale-110 transition-all duration-300 ease-linear' />}
       />

<ImageCard title="Scenery"
       author="rini" 
       price="70"
